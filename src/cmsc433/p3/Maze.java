...
public class Maze implements Serializable {
	/**
	 * <p>
	 * The maze is a 2 dimensional array of atomic integers encoded as an
	 * AtomicIntegerArray. The upper-left, or north-western corner of the maze
	 * is given by maze.get(0). The lower-right, or south-eastern corner of the
	 * maze is maze.get(maze.length()-1). The maze is stored in row-major order,
	 * so the element at row n, column m is given by maze.get(n * width + m).
	 * </p>
	 * 
	 * <p>
	 * The entrance to the maze is at row: 0, column: width/2. The exit is at
	 * row: height-1, column: width/2.
	 * </p>
	 * 
	 * <p>
	 * Individual bits of each byte in the "maze" array are used to encode
	 * information about that cell of the maze. Only the low-order 8 bits are
	 * used. The designated bits are:
	 * </p>
	 * 
	 * <pre>
	 * CCSSEEse
	 ...
	 * </pre>
	 * 
	 * <dd>marks two bits that are used to give a color to this cell in the
	 * maze. Each of the four bit combinations corresponds to a different color
	 * that will be used by the MazeDisplay object when drawing this cell. This
	 * can be used by your code to provide visual feedback on solving progress
	 * or for debugging.
	 * <dt>
	 * 
	 * <pre>
	 ...
	 * </pre>
	 * 
	 * <dd>marks two bits that are used to give a color to the southern side of
	 * this cell.
	 * <dt>
	 * 
	 * <pre>
	 ...
	 * </pre>
	 * 
	 * <dd>marks two bits that are used to give a color to the eastern side of
	 * this cell.
	 * <dt>
	 * 
	 * <pre>
	 ...
	 * </pre>
	 * 
	 * <dd>Set to 1 if there is a wall to the SOUTH.
	 * <dt>
	 * 
	 * <pre>
	 * e
	 * </pre>
	 * 
	 * <dd>Set to 1 if there is a wall to the EAST.
	 * 
	 * <p>
	 * There is always a wall to the south of cells on the southern border of
	 * the maze. There is always a wall to the east of cells on the eastern
	 * border of the maze. There is an implicit wall to the north of cells on
	 * the northern border and to the west of cells on the western border.
	 * </p>
	 */
	...
	/**
	 * A reference to the graphical display of this maze. This will be null if
	 * graphical maze display is not currently enabled.
	 */
	...
	// Position variables used internally. Allocated once here to avoid
	// excessive memory allocation.
	private static final long serialVersionUID = 1L;

	/**
	 * Returns the integer at the given position. The returned value uses the
	 * encoding described in the documentation for the {@link Maze#maze maze}
	 * field.
	 */
	...
	/**
	 * Returns true if it is possible to move in direction @dir when at
	 * position @pos.
	 */
	public boolean canMove(Position pos, Direction dir) {
		...
		case NORTH:
			if (pos.row == 0)
				...
				return (getCell(pos.move(Direction.NORTH)) & SOUTH_BIT) == 0;
		case SOUTH:
		...
		case WEST:
			if (pos.col == 0)
				...
				return (getCell(pos.move(Direction.WEST)) & EAST_BIT) == 0;
		}
	...
	/**
	 * Returns the list of open directions at this position. A direction is open
	 * if it is not blocked by a wall.
	 */
	...
	/**
	 * Sets the color of the cell at position 'pos' to the specified value,
	 * which must be between 0 and 3 inclusive.
	 */
	...
	/**
	 * Gets the color of the cell at position 'pos'. The returned value will be
	 ...
	 * wall of top-row cells and the western wall of left-column cells cannot be
	 * colored.
	 */
	...
	/**
	 * Gets the color of the edge in direction 'dir' at position 'pos'. The
	 * northern wall of top-row cells and the western wall of left-column cells
	 * cannot be colored. The color 0 will be returned for these cases.
	 */
	...
	/**
	 * Sets the color of the eastern edge of the cell at position 'pos' to the
	 * specified value, which must be between 0 and 3 inclusive.
	 */
	...
	/**
	 * Gets the color of the eastern edge of the cell at position 'pos'. The
	 * returned value will be between 0 and 3 inclusive.
	 */
